...
from plugins.helper_functions.misc import is_module_loaded
...
if is_module_loaded(FILENAME):
    ...
    from info import EVENT_LOGS, LOGGER, dispatcher
    from plugins.helper_functions.chat_status import user_admin
